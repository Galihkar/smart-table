...
class SmartTable {
  ...
  injectToolbar() {
    ...
    resizeSection.className = 'toolbar-section';
    this.resizeBtn = document.createElement('button');
    this.resizeBtn.className = 'dropdown-toggle';
    this.resizeBtn.innerHTML = '<i class="fas fa-text-width"></i>';
    this.resizeBtn.title = 'Fit Column Width';
    resizeSection.appendChild(this.resizeBtn);

    this.toolbar.appendChild(columnSection);
    this.toolbar.appendChild(filterSection);
    this.toolbar.appendChild(exportSection);
    this.toolbar.appendChild(resizeSection);
